...
# source file: https://data.cms.gov/provider-data/sites/default/files/archive/Nursing%20homes%20including%20rehab%20services/2022/nursing_homes_including_rehab_services_2022.zip

# Import source file and save to original for backup
source_file <- "https://data.cms.gov/provider-data/sites/default/files/archive/Nursing%20homes%20including%20rehab%20services/2022/nursing_homes_including_rehab_services_2022.zip"

data_dir_orig <- "data/us_hhs_cms_2014_2022_nursing_home_health_fire_deficiencies/original"
data_dir_work <- "data/us_hhs_cms_2014_2022_nursing_home_health_fire_deficiencies/working"
dwnld_file_path <- file.path("data/us_pl_cms_2018_2022_nursing_home_health_fire_deficiencies/original", basename(source_file))
